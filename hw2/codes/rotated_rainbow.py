...
class RotatedRainbow():
    def __init__(self):
        ...
        self.rotation_deg_per_sec = 600 # rotated speed in degrees per second
        ...
        self.distance = 1000 # rainbow distance in meters
...
# self.lower_wavelengths_nn = [700, 600, 570, 520, 450, 420, 380]    
